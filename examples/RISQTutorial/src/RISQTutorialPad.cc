...
// Primary Constructor
RISQTutorialPad::RISQTutorialPad(G4RotationMatrix * pRot,
...
void RISQTutorialPad::ConstructPad(G4RotationMatrix * pRot,
							     const G4ThreeVector & tLate,
							     const G4String & pName,
							     G4LogicalVolume * pMotherLogical,
							     G4bool pMany,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<std::tuple<std::string,G4String,G4VPhysicalVolume*> > RISQTutorialPad::GetListOfAllFundamentalSubVolumes()
{
